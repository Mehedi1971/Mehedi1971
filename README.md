...
<p>As a dedicated <strong>Software Engineer</strong>, I bring substantial expertise in developing <strong>robust, enterprise-level applications</strong> with a focus on <strong>Java</strong> and the <strong>Spring framework</strong>. I am driven by a passion for crafting <strong>scalable, high-performance systems</strong>, applying <strong>clean code principles</strong>, and adhering to <strong>proven design patterns</strong>. My strong background in <strong>requirement analysis</strong>, meticulous <strong>code reviews</strong>, and <strong>collaborative teamwork</strong> ensures that I consistently deliver high-quality software solutions. With a solid foundation in <strong>object-oriented development</strong>, I continuously strive to <strong>refine processes</strong>, <strong>optimize performance</strong>, and exceed expectations in every project, delivering <strong>precise</strong> and <strong>timely results</strong>.</p>
<hr/>
...
- [**🧪 LIMS (Laboratory Information Management System)**](#)  
  *A comprehensive platform to manage lab workflows, track samples, and ensure data integrity for laboratory processes.*  
  ...
  ![Redis](https://img.shields.io/badge/Redis-%E2%9C%85-red)
...
<div align="center">
  <a href="https://www.linkedin.com/in/md-mahedihasan">
    <img src="https://img.shields.io/badge/-Mahedi-blue?style=flat-square&logo=Linkedin&logoColor=white">
  </a>
  <a href="mailto:md.mahedi.10001@gmail.com">
    <img src="https://img.shields.io/badge/-Mahedi-c14438?style=flat-square&logo=Gmail&logoColor=white">
  </a>
</div>
